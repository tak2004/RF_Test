...
{
TestSuite::TestSuite(const RF_Type::String& Name) : m_Name(Name)
{
...
void TestSuite::AddTest(TestMethod Test,
...
RF_Mem::AutoPointer<RF_Test::TestResult>
TestSuite::ProcessTest(const RF_Type::UInt32 Number)
{
  RF_Type::Bool passed;
...
RF_Collect::List<RF_Mem::AutoPointer<RF_Test::TestResult>>&
